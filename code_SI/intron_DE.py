...
val_avg_gene = df[(df["FlyBase ID"].isin(genes_nogap_avg)) & (df["FlyBase ID"].isin(fb_expr))]["log2(SRPK/Control)"]
val_long_gene = df[(df["FlyBase ID"].isin(long_intron_gene_name)) & (df["FlyBase ID"].isin(fb_expr))]["log2(SRPK/Control)"]
